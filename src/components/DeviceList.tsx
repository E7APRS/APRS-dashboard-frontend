...
export default function DeviceList({ positions, selectedId, onSelect }: Props) {
  ...
  return (
    <>
      ...
      <div className="flex border-b border-gray-500/85 dark:border-gray-500/85 text-xs text-gray-600 dark:text-gray-400">
        <button
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between">
                <span className="font-mono font-semibold text-brand-onyx dark:text-white">{pos.callsign}</span>
                <span
