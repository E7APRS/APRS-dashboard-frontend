...
export default function Legend({activeSources}: Props) {
    ...
    return (
        <div
            className="absolute bottom-8 right-2 z-[1000] bg-white/95 dark:bg-brand-onyx/95 text-xs px-3 py-2 rounded shadow border border-gray-500/85 dark:border-gray-500/85 space-y-1.5">
