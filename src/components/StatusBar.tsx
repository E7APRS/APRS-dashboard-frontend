...
export default function StatusBar({connected, activeSources, deviceCount, onSignOut}: Props) {
    return (
        <header
            className="flex items-center gap-4 px-4 py-0 bg-white dark:bg-brand-onyx border-b border-gray-500/85 dark:border-gray-500/85 text-xs text-gray-600 dark:text-gray-400 h-12 flex-shrink-0 shadow-sm dark:shadow-none">
            {/* Brand identity */}
          ...
          <span
              className="font-rajdhani font-bold text-base text-gray-700 dark:text-brand-silver tracking-widest uppercase">
            E7APRS
          </span>
                    <span
                        className="font-rajdhani text-[9px] text-brand-dark-orange dark:text-brand-orange tracking-widest uppercase">
            DMR &amp; APRS Network
          </span>
                </div>
            </div>
